...
export PACKAGES=" ${PACKAGES} luci-app-cjdns mini_snmpd nano"
export PACKAGES=" ${PACKAGES} tcpdump wpad-mesh-openssl yggdrasil"
export PACKAGES=" ${PACKAGES} dnscrypt-proxy dnscrypt-proxy-resolvers luci-app-dnscrypt-proxy"
export PACKAGES=" ${PACKAGES} luci-theme-material ipset kmod-ipt-ipset"
